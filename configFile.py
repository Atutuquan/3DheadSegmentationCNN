...
#availabledatasets :'ATLAS17', 'BRATS15', 'BRATS15_TEST', 'BRATS15_wholeNormalized' ,BRATS15_WHOLE', 'Custom' (for explicitly giving channels)
dataset = 'BRATS15_wholeNormalized'
...
elif dataset == 'BRATS15_WHOLE':
    '''Example data BRATS 2015 - 4 input channels - 5 output classes'''
    
    trainChannels = ['/home/lukas/Documents/projects/public_SegmentationData/BRATS2015_Training/flairChannels',
                    '/home/lukas/Documents/projects/public_SegmentationData/BRATS2015_Training/t1Channels',
                    '/home/lukas/Documents/projects/public_SegmentationData/BRATS2015_Training/t1cChannels',
                    '/home/lukas/Documents/projects/public_SegmentationData/BRATS2015_Training/t2Channels']
...
L2 = 0.0001
load_model = False
path_to_model = '/home/lukas/Documents/projects/brainSegmentation/deepMedicKeras//Output/models/TrainSessionBRATS15_WHOLE_DeepMedic2018-02-15_1850.h5'
logfile_model = 'TrainSessionBRATS15_WHOLE_DeepMedic2018-02-15_1850'
num_channels = 4
...
n_patches = 6380
n_subjects = 220 # Check that this is not larger than subjects in training file
size_minibatches = 60 # Check that this value is not larger than the ammount of patches per subject per class

n_patches_val = 500
n_subjects_val = 20 # Check that this is not larger than subjects in validation file
...
########################################### TEST PARAMETERS
n_fullSegmentations = 5
#list_subjects_fullSegmentation = [0,1,2,3,4,12,13,14,15]
epochs_for_fullSegmentation = [0,5,9]
